...
{
    /// <summary>Colour language of the grove. Energy colours are additive bit masks.</summary>
    public static class Pal
    {
        ...
        public const int Any = 0;   // lamps that accept any live colour
        ...
        public static Color Energy(int mask) => Table[mask & 7];
        ...
        public static string EnergyName(int mask) => Names[mask & 7];
