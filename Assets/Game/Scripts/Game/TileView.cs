...
namespace GlimmerGrove
{
    ...
    public sealed class TileView : MonoBehaviour, IPointerClickHandler
    {
        ...
        {
            var col = Pal.Energy(cell.colour);
        ...
        {
            var want = cell.colour == Pal.Any ? Pal.Cream : Pal.Energy(cell.colour);
        ...
        void ApplyLamp(bool animate, float delay)
        {
            ...
            var want = _p.C[_i].colour == Pal.Any ? Pal.Cream : Pal.Energy(_p.C[_i].colour);
        ...
        {
            var col = Pal.Energy(Mathf.Max(1, _p.Energy(_i)));
            Tween.After(delay, () =>
            {
                if (this == null) return;
